...
### To vote on a proposal using the AWS Management Console<a name="w40aac24c11b5b1"></a>
...
### To vote on a proposal using the AWS CLI<a name="w40aac24c11b5b3"></a>
...
### To create an invitation proposal using the AWS Management Console<a name="w40aac24c13b5b1"></a>
...
### To create an invitation proposal using the AWS CLI<a name="w40aac24c13b5b3"></a>
...
### To create a proposal to remove a member using the AWS Management Console<a name="w40aac24c15b5b1"></a>
...
### To create a removal proposal using the AWS CLI<a name="w40aac24c15b5b3"></a>
+ Type a command similar to the following\. Replace the value of `Principal` with the AWS account ID that you want to invite\. Replace the value of `--member-id` with the value for the member in your account that submits the proposal\.
